...
| **Level 5** | (8 + CON mod) x **8** | 4 adventurer1 champion | 4 |  | 2 x ability modifier |
| **Level 6** | (8 + CON mod) x **10** | 4 adventurer2 champion | 4 |  | 2 x ability modifier |
| **Level 7** | (8 + CON mod) x **12** | 4 adventurer3 champion | 4 | +1 to 3 abilities | 2 x ability modifier |
| **Level 8** | (8 + CON mod) x **16** | 4 adventurer3 champion1 epic | 5 |  | 3 x ability modifier |
