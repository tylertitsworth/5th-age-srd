...
| **Level 5** | (6 + CON mod) x **8** | 4 adventurer1 champion | 6 | 5th level |  | 2 x ability modifier |
| **Level 6** | (6 + CON mod) x **10** | 4 adventurer2 champion | 7 | 5th level |  | 2 x ability modifier |
| **Level 7** | (6 + CON mod) x **12** | 4 adventurer3 champion | 7 | 7th level | +1 to 3 abilities | 2 x ability modifier |
| **Level 8** | (6 + CON mod) x **16** | 4 adventurer3 champion1 epic | 8 | 7th level |  | 3 x ability modifier |
| **Level 9** | (6 + CON mod) x **20** | 4 adventurer3 champion2 epic | 8 | 9th level |  | 3 x ability modifier |
| **Level 10** | (6 + CON mod) x **24** | 4 adventurer3 champion3 epic | 9 | 9th level | +1 to 3 abilities | 3 x ability modifier |
